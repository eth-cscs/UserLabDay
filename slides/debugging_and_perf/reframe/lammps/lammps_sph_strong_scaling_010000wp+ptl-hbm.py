...
class LAMMPSPerfHackathon(RunOnlyRegressionTest):
    def __init__(self, name, **kwargs):
        ...
        self.modules = ['LAMMPS/16Jul2018-CrayCCE-18.07-cuda-9.1-ptl-hbm-7.0.2']
        ...
        self.pre_run = ['module list -t && gunzip data.initial.gz']
...
class LAMMPSStrongScaling(LAMMPSPerfHackathon):
    def __init__(self, num_tasks, **kwargs):
        super().__init__('LAMMPS_%s_010000wp_strong+ptl-hbm' % (str(num_tasks)), **kwargs)
